...
const Home = () => {
  ...
  return (
    <>
      ...
      <section id="contact" className="min-h-screen bg-[#090b14] flex items-center justify-center px-4 py-8 relative overflow-hidden">
            ...
            >
              <form onSubmit={handleSubmit} className="space-y-6">
                <div className="space-y-2 mb-8">
                  <h4 className="text-3xl font-bold text-white">Send a Message</h4>
